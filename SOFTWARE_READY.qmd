...
*Examples: different timezone annotation details for April 3, 2023 standardized to ISO 8601*
...
Persistent unique identifiers (PIDs) are globally unique identifiers to unambiguously identify granules of information in a machine-readable way. Identifiers can exist in acquired data, or they may be created. It is important to manage any identifiers you create, if they are not managed by an authority (e.g. DOIs).
