...
-   [Documentation] (https://iocm.noaa.gov/standards/cmecs-home.html) of the CMECS standard, how to use it (including examples), and how to contribute to its improvement
