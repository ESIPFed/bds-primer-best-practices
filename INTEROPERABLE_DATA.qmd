...
> Note: Semantic resources may or may not imply or define relationships to other values. Learning how to use them correctly helps your data be precise and powerful! When all is said and done, there isn't a semantic resource for everything, but when it's there, it's a good idea to use it.
...
-  {{< video https://www.youtube.com/watch?v=bMdCwrTIFfs width="200" height="100"  >}}
...
_Note: To our surprise, this definition became one of the most discussed pieces of information in developing this guidance. We are comfortable with where it's at right now, but feel free to open up a GitHub issue if you think it needs improvement._
...
- {{< video https://www.youtube.com/watch?v=MGsstbDYAMU width="200" height="100"  >}}
...
- {{< video https://www.youtube.com/watch?v=VCy0C1qj3kw width="200" height="100"  >}}
...
-- {{< video https://www.youtube.com/watch?v=ntZDzBE3pO0
