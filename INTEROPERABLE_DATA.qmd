...
variety of tools complements NVS usability

-   [NVS Vocab Search](https://www.bodc.ac.uk/resources/vocabularies/vocabulary_search/) - tool to search the entire NVS content

-   [SeaDataNet Search](https://vocab.seadatanet.org/search) - interface to only search on collections used by the SeaDataNet data infrastructure
...
CMECS (and the NVC and Wetlands standards) were endorsed by the US FGDC so that data collectors and analysts can describe data using standard terminology and organization structures. This enables data discovery and thereby data use and re-use of Federally funded data assets.
...
This as well as its hierarchical nature makes the classification scalable for diverse applications from vegetation monitoring to broad-scale analyses of trends across North America. Additional applications include:
...
This as well as its hierarchical nature makes the classification scalable for diverse applications from vegetation monitoring to broad-scale analyses of trends across North America.
