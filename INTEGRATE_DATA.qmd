...
-   For more information, see overviews of CF as a [presentation](https://cfconventions.org/Data/cf-documents/overview/viewgraphs.pdf) and [paper](https://cfconventions.org/Data/cf-documents/overview/article.pdf). You can also check out the presentation John Weiczorek gave to our ESIP cluster back in April, 2022:
    ...
    {{< video https://youtu.be/yOJhP9995TU title="Introduction to Darwin Core by John Weiczorek" start="63">}}
...
4.  For more information, see overviews of CF as a [presentation](https://cfconventions.org/Data/cf-documents/overview/viewgraphs.pdf) and [paper](https://cfconventions.org/Data/cf-documents/overview/article.pdf). You can also check out the presentation Roy Lowry gave to our ESIP cluster back in April, 2022:
    ...
    {{< video https://youtu.be/yOJhP9995TU title="Introduction to CF Conventions by Roy Lowry" start="469">}}
