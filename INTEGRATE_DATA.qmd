...
Like many standards, CF is built on other standards. For example, units are specified using the [UDUNITS system](https://cfconventions.org/faq.html#units-in-cf-udunits) and files formats are defined by the [netCDF (Network Common Data Form) standard](https://www.ogc.org/publications/standard/netcdf/). These standards have been around for about 30 years, and have facilitated the efficient processing and sharing ofclimate and oceanographic data.
