...
To paraphrase the [MARCO-BOLO data management plan](https://doi.org/10.5281/zenodo.8208410), the main challenge with biological data is that it comes in many flavors. For example, it may include evidence of past or present organisms based on physical samples, chemicals, organic molecules, sound, or images. By using standards to organize and share data efficiently, biologists can turn this diversity of data types into a strength rather than a challenge of dealing with biological data.
 ...
 |  |  |
|---------------------------------|---------------------|------------------|
| Helping People Climb | Always Feeding Back | Transparent |
...
{{< fa solid fa-person-hiking size=lg >}} Helping People Climb: We want to help people learn about data standards resources. We want to see higher quality data publishing in science. We were students too; we know how little of this is part of a standard science education.

{{< fa solid fa-arrows-spin size=lg  >}} Always Feeding Back: Information and standards develop too quickly to bury them in a journal. The goal here is that _you_ can immediately let us know what isn't working, or what is wrong, via GitHub issues. We're excited to work with you to make this better!

{{< fa solid fa-magnifying-glass size=lg  >}} Transparent: Sometimes standards are confusing until you understand the journey of how it was created.  Having experienced this ourselves, we want to share the conversations that helped us edit this resource.
