...
We build on the Primer by providing additional context and details in this Primer Guide. The guide is intended to be a bridge between a deep dive into the standards documentation, and the lists of links available in the primer. 

**Audience**

The target audience for these guides is anyone interested in working with biological data, from data collection, to data sharing, and data management. We hope these Primer Guides will provide useful context for using biological standards.

Currently we only have the capacity to offer it in english. However, users can get a rough translation using Google Translate. Just drop the url in this service:
